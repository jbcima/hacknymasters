var speakers = [
  {
    ...
    "github": "detour1999",
    "twitter": "dylanr",
    "bio": 'Dylan Richard is the full-bearded technologist who, as Director for Engineering, quietly led the 40 engineers of Obama for Americaâ€™s Technology team to victory in 2012. Previously, he helmed technical teams as Vice President of Engineering at skinnyCorp (home of threadless.com) and was a Senior Developer at Crate & Barrel. Dylan lives in Chicago, Illinois, with his patient wife, Sarah, two amazing sons, a cat, and a rotating stable of old diesel VWs. His possible favorite claim to fame is having his chest-length beard proclaimed â€œfierceâ€ by President Barack Obama.',
    "abstract": "",
  ...
  },
  {
    ...
    "abstract": "This will be a talk focusing on the theory and implementation details of how visualisations should be presented for monitoring data. Everyone is used to standard line graphs but what goes into designing them, creating a good user experience and what other types of visualisations are appropriate for which situations? This talk will consider questions such as:<br /><br /><ul><li>How are colours important? Both for brand identification and consistent user experience.</li><li>How do you visualise large volumes of data - hundreds of series?</li><li>Is there any value in anomaly detection or prediction?</li><li>What alternatives are there to line graphs? And when should they be used? Picking the right visualisation for the right use case.</li><li>Are graphs always appropriate? What are you trying to visualise and whatâ€™s the best way to achieve it?</ul><br />This talk will focus on design and interaction, with theory and examples, to help get the best out of monitoring metric visualisations.",
  ...
  },
  {
    ...
    "abstract": "Infrastructure is Secondary<br /><br />Itâ€™s 3am, and your phone has rudely awakened you with the message &quot;ALERT: load average on myapp-backend01 is above 0.8&quot;. Does that mean anything to your users or your customers? Instead, what if you got to sleep through the night because that high load average wasnâ€™t a real problem: you were just serving a bit more traffic than usual?<br /><br />This talk will discuss the merits of measuring and monitoring your business first and your infrastructure second. It will cover strategies for deciding what to measure, methods for measuring those things, and how to use them to make good operational decisions.",
  ...
  },
  {
    ...
    "bio": "Michael Gorsuch is a hacker at GitHub, focusing on operations and availability. If he had to choose a job title, it would be &quot;Sidekick as a Service.&quot; He currently resides in Oklahoma with his wife, two kids and a pile of E.L. James novels.",
    "abstract": "",
